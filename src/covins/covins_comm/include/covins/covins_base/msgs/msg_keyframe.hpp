...
public:
    ...
    TypeDefs::AorsVector              keypoints_aors;       
    TypeDefs::ClassVector             keypoint_classes;                                                                              //Angle,Octave,Response,Size
    cv::Mat                 descriptors;
    ...
    auto save(Archive &archive) const ->void {
        if(save_to_file) {
            archive(timestamp,id,
                    ...
                    keypoints_distorted,keypoints_undistorted,keypoints_aors,descriptors,keypoint_classes,
                    T_s_c,T_w_s,
