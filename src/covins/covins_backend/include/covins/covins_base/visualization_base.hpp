...
public:
    ...
    static auto CreateSemanticPoint3D(Eigen::Vector3d &p3D, size_t client_id, int class_label)  ->pcl::PointXYZRGB;
...
protected:
    ...
    ros::Publisher              pub_cloud_labeled_;
    ros::Publisher              pub_trajectories_;
    std::string                 topic_prefix_                                           = std::string();
    // Hack for the time being :3
    ros::Publisher              pub_keyframes_1_;
    ros::Publisher              pub_keyframes_2_;
